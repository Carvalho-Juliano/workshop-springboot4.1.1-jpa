...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o2 = new Order(null, Instant.parse("2026-07-21T03:53:10Z"), OrderStatus.WAITING_PAYMENT, u2);
    Order o3 = new Order(null, Instant.parse("2026-04-20T22:53:07Z"), OrderStatus.WAITING_PAYMENT, u1);
